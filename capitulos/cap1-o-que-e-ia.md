# Capítulo 1 — O que é IA e o que não é
...
Pense em **círculos concêntricos**, do maior para o menor:
...
> **Analogia:** é como o corretor preditivo do celular — só que com uma capacidade incomparavelmente maior de levar em conta o contexto. Quando o texto resultante soa inteligente, é porque os **padrões da linguagem humana** estão embutidos nas probabilidades, não porque há compreensão por trás.
...
> **Componente Viz:** cards "Mito × Fato".
